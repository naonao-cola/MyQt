...
void MainWidget::createControlFrame(){
    ...
    scaleSlider->setRange(0,int(2*scaleValue));
    ...
    shearSlider->setRange(0,int(2*shearValue));
    shearSlider->setValue(int(shearValue));
    ...
    translateSlider->setRange(0,int(2*translateValue));
    translateSlider->setValue(int(translateValue));
